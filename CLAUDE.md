...
agentfuse/
  ...
  evals/                      the benchmark + real-trace pipeline
    generators.py               25-family synthetic scenario generator (1018 scenarios, seed=20260812)
    ...
    test_*.py                   365 tests total, `pytest evals/ -q`
...
pytest evals/ -q                                           # 365-test gate (~5-6 min)
