...
**As of 2026-09-13** · 449 commits · 375 tests green, confirmed in CI itself (all 9 matrix cells + mypy + benchmark + demos, not just locally — section 3.35) · 1018 synthetic scenarios across 25 families (0 errors) + real suite: 34 runs across 2 domains (6 positives / 28 negatives, precision 100% / recall 83.3% / FPR 0% — section 3.19)
...
Measured on 1018 generated scenarios across 25 families and 6 domains, replayed
...
pytest evals/ -q                                  # 334-test CI gate
```
